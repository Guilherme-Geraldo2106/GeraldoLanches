...
namespace GeraldoLanches.Areas.Admin.Controllers
{
    ...
    public class AdminProdutosController : Controller
    {
        ...
        public AdminProdutosController(AppDbContext_context context)
        {
            _context = context;
        }
        ...
        {
            var resultado = _context.Lanches.AsNoTracking()
                                      .AsQueryable();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext_context.Lanches'  is null.");
            }
            var lanche = await _context.Lanches.FindAsync(id);
            if (lanche != null)
            {
